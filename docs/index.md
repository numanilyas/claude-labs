...
Every number in this curriculum is invented. "Northwind Trading Co." doesn't
exist, the bank is fictional, the vendors are made up. This is deliberate —
learn the mechanics on data that can't hurt anyone, then point the same
technique at the real thing.

The files are also *wrong* on purpose. The P&L has formatting crimes in it.
The bank statement genuinely doesn't reconcile to the ledger. That's the
point: a clean file teaches you nothing.
